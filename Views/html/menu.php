<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Prueba</span>
        </a>
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <a href="empleados/empleados.views.php" target="base" class="menu-link">
                    <?php $_SESSION['rutas'] = 'Autor'; ?>
                        <div data-i18n="Container">Autor</div>
                    </a>
                </li>
                <li class="menu-item">
                <a href="Libros/libro.views.php" target="base" class="menu-link">
                    <?php $_SESSION['rutas'] = 'Libros'; ?>
                        <div data-i18n="Fluid">Libros</div>
                    </a>
                </li>
                <li class="menu-item">
